...
export class ApiProvider {
	private base_url: string = 'https://www.nujogja.or.id/wp-json/wp/v2/';
    ...
    getBeritaUtama(page) : Observable<any> {
        return this.http.get(this.base_url + 'posts?_embed&per_page=5&page=' + page + '&categories=2')
    }
